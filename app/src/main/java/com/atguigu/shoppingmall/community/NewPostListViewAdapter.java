...
public class NewPostListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //图像
        Glide.with(mContext).load(Constant.BASE_URL_IMAGE + entity.getAvatar()).into(viewHolder.ibNewPostAvatar);
        viewHolder.tvCommunityUsername.setText(entity.getUsername());
        //图像
        Glide.with(mContext).load(Constant.BASE_URL_IMAGE + entity.getFigure()).into(viewHolder.ivCommunityFigure);
