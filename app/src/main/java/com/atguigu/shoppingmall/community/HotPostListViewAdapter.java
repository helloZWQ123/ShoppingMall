...
public class HotPostListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //图像
        Glide.with(mContext).load(Constant.BASE_URL_IMAGE + entity.getAvatar()).into(viewHolder.ivNewPostAvatar);

        viewHolder.tvHotUsername.setText(entity.getUsername());
        //图像
        Glide.with(mContext).load(Constant.BASE_URL_IMAGE + entity.getFigure()).into(viewHolder.ivHotFigure);
