...
import static com.atguigu.shoppingmall_1020.R.id.et_price_start;
import static com.atguigu.shoppingmall_1020.R.id.ll_price_root;
import static com.atguigu.shoppingmall_1020.R.id.tv_drawer_price;
...
public class GoodsListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getData();
        datas = new CheckBox[]{cbPriceNoLimit, cbPrice015, cbPrice1530,
                cbPrice3050, cbPrice5070, cbPrice70100, cbPrice100, cbPriceDiy};
    }
...
//        Toast.makeText(this, "" + position, Toast.LENGTH_SHORT).show();
    ...
    @OnClick({R.id.ib_goods_list_back, R.id.tv_goods_list_search,
            R.id.ib_goods_list_home, R.id.tv_goods_list_sort,
            R.id.tv_goods_list_price, R.id.tv_goods_list_select,
            R.id.ib_drawer_layout_back, R.id.ib_drawer_layout_confirm,
            ...
            R.id.btn_drawer_type_confirm, R.id.rl_price_nolimit,
            R.id.rl_price_0_15, R.id.rl_price_15_30, R.id.rl_price_30_50,
            R.id.rl_price_50_70, R.id.rl_price_70_100, R.id.rl_price_100, R.id.rl_diy_price})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.rl_price_nolimit:
                Log.e("TAG", "123");
                setCbChecked(cbPriceNoLimit);
                break;
            case R.id.rl_price_0_15:
                setCbChecked(cbPrice015);
                break;
            case R.id.rl_price_15_30:
                setCbChecked(cbPrice1530);
                break;
            case R.id.rl_price_30_50:
                setCbChecked(cbPrice3050);
                break;
            case R.id.rl_price_50_70:
                setCbChecked(cbPrice5070);
                break;
            case R.id.rl_price_70_100:
                setCbChecked(cbPrice70100);
                break;
            case R.id.rl_price_100:
                setCbChecked(cbPrice100);
                break;
            case R.id.rl_diy_price:
                setCbChecked(cbPriceDiy);
                break;
...
//                tv_drawer_price.
                for (int i = 0; i < datas.length; i++) {
                    if(datas[i].isChecked()) {
                        if(i == 1) {
                            tvDrawerPrice.setText("0-15");
                        } else if(i == 2) {
                            tvDrawerPrice.setText("15-30");
                        }else if(i == 3) {
                            tvDrawerPrice.setText("30-50");
                        }else if(i == 4) {
                            tvDrawerPrice.setText("50-70");
                        }else if(i == 5) {
                            tvDrawerPrice.setText("70-100");
                        }else if(i == 6) {
                            tvDrawerPrice.setText("100以上");
                        }else if(i == 7) {
                            tvDrawerPrice.setText(etPriceStart.getText()+"-"+etPriceEnd.getText());
                        }
                    }
                }
    ...
    private void setCbChecked(CheckBox checkBox) {
        for (int i = 0; i < datas.length; i++) {
            datas[i].setChecked(false);
        }
        checkBox.setChecked(true);
        Log.e("TAG", ""+datas.length);
    }
